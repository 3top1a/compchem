...
class ExperimentsWorkflowResource(RecordResource):
    ...
    def post_available(self):
        ...
        try:
            ...
            return jsonify(
                {"error": f"Failed to connect to workflow service: {str(e)}"}
            ), 502
    ...
    def post_create(self):
        ...
        try:
            ...
            recordId = request.view_args.get("record_id")
            data = request.get_json()

            go_api_url = f"{self.FILEPROCESSOR_URL}/v1/workflows/{recordId}"
            response = requests.post(
                go_api_url,
                json=data,
                headers={"Content-Type": "application/json"},
    ...
    def post_create_all(self):
        ...
        try:
            ...
            go_api_url = f"{self.FILEPROCESSOR_URL}/v1/workflows/{recordId}/all"
            response = requests.post(
                go_api_url,
                json=data,
                headers={"Content-Type": "application/json"},
    ...
    def get_workflow_logs(self):
        ...
        try:
            ...
            return jsonify(
                {"error": f"Failed to connect to Argo server: {str(e)}"}
            ), 502
        except Exception as e:
            return jsonify({"error": f"Internal server error: {str(e)}"}), 500
